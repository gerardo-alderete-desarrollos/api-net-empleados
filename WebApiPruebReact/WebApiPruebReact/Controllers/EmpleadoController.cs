...
using WebApiPruebReact.Models;

namespace WebApiPruebReact.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmpleadoController : ControllerBase
    {
        private readonly DbloginContext dbContext;
        public EmpleadoController(DbloginContext _dbContext)
        {
